...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      autoComplete="off"
      className={cn(
        "border-ring block h-9 w-full rounded-sm border bg-white px-3 py-2 shadow-xs placeholder:italic placeholder:opacity-90 sm:text-sm dark:bg-[hsl(218,_13%,_10%)] dark:text-white dark:shadow-black dark:placeholder:opacity-40",
